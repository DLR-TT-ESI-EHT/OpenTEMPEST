...
block SlewRateLimiterVariable "Limits the slew rate of a signal"
  ...
  Modelica.Blocks.Interfaces.RealInput Rising "Maximum rising slew rate [+small..+inf) [1/s]"
    annotation (Placement(transformation(extent={{-140,50},{-100,90}})));
  Modelica.Blocks.Interfaces.RealInput Falling "Maximum falling slew rate (-inf..-small] [1/s]"
