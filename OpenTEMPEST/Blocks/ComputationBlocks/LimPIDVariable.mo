...
equation
  ...
  connect(limiter.limit1, yMax) annotation (Line(points={{68,8},{66,8},{66,66},
          {-120,66},{-120,70}}, color={0,0,127}));
  connect(yMin, limiter.limit2) annotation (Line(points={{-120,-70},{-120,-84},
          {68,-84},{68,-8}}, color={0,0,127}));
